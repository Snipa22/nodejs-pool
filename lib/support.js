...
function rpc_wallet(host, port, method, params, callback) {
    ...
    return jsonRequest(host, port, data, true, callback, 'json_rpc', 20*60*1000);
}
...
module.exports = function () {
    return {
        rpcDaemon: function (method, params, callback) {
            rpc(global.config.daemon.address, global.config.daemon.port, method, params, callback, 10*1000);
        },
        rpcPortDaemon: function (port, method, params, callback) {
            rpc(global.config.daemon.address, port, method, params, callback, 10*1000);
        },
