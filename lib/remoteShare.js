...
if (cluster.isMaster) {
    ...
    global.database.worker_id = cluster.worker.id;
    global.database.splitCache('global_stats');
    global.database.splitCache('pplns_stats');
    global.database.splitCache('pps_stats');
    global.database.splitCache('solo_stats');
