...
function updatePoolStats2(poolType) {
    ...
    blockList = blockList.length ? blockList.slice(1000).concat(global.database.getBlockList(poolType, 0, 1000))
                                 : global.database.getBlockList(poolType);
    altblockList = altblockList.length ? altblockList.slice(10000).concat(global.database.getAltBlockList(poolType, null, 0, 10000))
