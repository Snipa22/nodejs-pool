...
function updatePoolStats2(poolType) {
    ...
    altblockList = altblockList.length ? blockList.slice(0, altblockList.length > 10000 ? altblockList.length - 10000 : 0).concat(
                                         global.database.getBlockList(poolType, altblockList.length - 10000))
