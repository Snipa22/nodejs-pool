    ...
    async.waterfall([
        ...
        function (height, callback) {
			...
			const identifier = share.identifier;
                        ...
                        if (port in localPortHahes) localPortHahes[port] += share.shares;
                ...
                for (port in localPortHashes) localPortHashes[port] = Math.floor(localPortHashes[port] / (hashrate_avg_min*60)) + 1;
                cache_updates["port_hash"] = localPortHahes;
