        ...
        function (height, callback) {
			...
			const identifier = share.identifier;
                        ...
                        if (minerID in minerSet) {
                            ...
                            localStats.miners2[minerID] += share.shares2;
                        ...
                        if (!(minerID in minerPortSet) && share.shares2) minerPortSet[minerID] = port; // set port only for parent port share

                        if (minerIDWithIdentifier in minerSet) {
                            localStats.miners[minerIDWithIdentifier]  += share.shares;
                            localStats.miners2[minerIDWithIdentifier] += share.shares2;
