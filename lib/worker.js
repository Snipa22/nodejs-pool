        ...
        function (height, callback) {
            ...
            async.doUntil(function (callback_until) {
                ...
                prevMinerList.forEach(function (miner) {
                    if (minerList.indexOf(miner) !== -1) continue; // we still have this miner in current list
                ...
                // find new workers
                minerList.forEach(function (miner) {
                    if (prevMinerList.indexOf(miner) !== -1) continue; // we still have this miner in previous list
