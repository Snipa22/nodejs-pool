...
function updateShareStats() {
    ...
    const history_power = Math.exp(global.config.general.statsBufferHours * Math.log(global.config.general.statsBufferLength) / 60 / global.config.general.statsBufferLength);
    comsole.log("History power: " + history_power);
