...
function updatePoolStats(poolType) {
    ...
    async.series([
        ...
        if (typeof(poolType) === 'undefined') updateBlockHeader();
    });
}
...
if (global.config.pps.enable === true)  setInterval(updatePoolStats, 5000, 'pps');
if (global.config.solo.enable === true) setInterval(updatePoolStats, 5000, 'solo');
