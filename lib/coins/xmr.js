...
function Coin(data){
    ...
    this.algoCheck = function(algos) {
        return true; //algos.includes("cn/r") ? true : "algo array must include cn/r";
    }
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 11898: return "argon2/chukwa"; // TRTL
            case 12211: return "cn/gpu";        // RYO
            case 13007: return "cn-pico/trtl";  // IRD
            case 17750: return "cn-heavy/xhv";  // Haven
            case 18081: return "cn/r";          // XMR
            case 18981: return "cn/rwz";        // Graft
            case 19734: return "cn/r";          // SUMO
            case 19994: return "cn-pico/trtl";  // ArqMa
            case 20189: return "defyx";         // Scala
            case 22023: return "rx/loki";       // LOKI
            case 24182: return "cn-heavy/tube"; // BitTube
            case 33124: return "c29s";          // XtendCash
