...
function Coin(data){
    ...
    this.getPortBlockTemplate = function(port, callback) {
		...
		method: 'getblocktemplate',
                ...
                console.log(global.config.pool["address_" + port.toString()]);
                return callback(body ? cnUtil.RavenBlockTemplate(body, global.config.pool["address_" + port.toString()]) : null);
            });
