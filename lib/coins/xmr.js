...
function Coin(data){
    ...
    this.convertAlgosToCoinPerf = function(algos_perf) {
        ...
        if      ("cn" in algos_perf)            coin_perf[""]     = coin_perf["LTHN"] = coin_perf["WOW"]  = algos_perf["cn"];
        else if ("cn/r" in algos_perf)          coin_perf[""]     = coin_perf["LTHN"] = coin_perf["WOW"]  = algos_perf["cn/r"];
