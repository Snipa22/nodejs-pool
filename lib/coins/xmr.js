...
function Coin(data){
    ...
    this.getCOINS = function() {
        return [ "GRFT", "LTHN", "RYO", "LOKI", "TUBE", "XHV", "AEON", "MSR", "XTL", "TRTL" ];
    }
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 18981: return multiHashing.cryptonight(convertedBlob, 1);       // Graft
            ...
            case 48782: return multiHashing.cryptonight(convertedBlob, 1);       // Lethean
    ...
    this.algoTypeStr = function(port, version) {
        switch (port) {
            ...
            case 11898: return "cryptonight-lite/1";     // TRTL
            case 12211: return "cryptonight-heavy/0";    // RYO
            case 17750: return "cryptonight-heavy/xhv";  // Haven
            case 18081: return "cryptonight/2";          // XMR
            case 18981: return "cryptonight/1";          // Graft
            ...
            case 48782: return "cryptonight/1";          // Lethean
            default:    return "cryptonight/2";
        }
    }
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 48782: return "cn/1";          // Lethean
            default:    return "cn/2";
        }
    }
    ...
    this.get_miner_agent_notification = function(agent) {
        ...
        if (m = reXMRig.exec(agent)) {
            ...
            if (majorv + minorv + minorv2 < 10500) {
                 return "You must update your cast-xmr miner (" + agent + ") to version v1.5.0+";
            }
