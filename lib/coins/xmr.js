...
function Coin(data){
    ...
    this.BlockTemplate = function(template) {
        ...
        if (is_mm) {
          console.log("xxxxxxxxxxxxxxxxx " + template.blocktemplate_blob.length);
          console.log(template.blocktemplate_blob.length);
          console.log(template.parent_blocktemplate_blob.length);
          console.log(template.reserved_offset);
          console.log(this.reserveOffset);
        }
