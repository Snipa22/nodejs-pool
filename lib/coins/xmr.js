...
function Coin(data){
    ...
    this.convertAlgosToCoinPerf = function(algos_perf) {
        ...
        else if ("cn" in algos_perf)            coin_perf[""]     = algos_perf["cn"];
        else if ("cn/1" in algos_perf)          coin_perf[""]     = algos_perf["cn/1"];
    ...
    this.cryptoNight = function(convertedBlob, port, height) {
        switch (port) {
            ...
            case 48782: return multiHashing.cryptonight(convertedBlob, 13);      // Lethean
