...
function Coin(data){
    ...
    this.BlockTemplate = function(template) {
        ...
        if (is_mm) {
            ...
            console.log("XXXXXXXXXXXXX0 " + template.blocktemplate_blob.length);
            console.log("XXXXXXXXXXXXX1 " + template.parent_blocktemplate_blob.length);
            console.log("XXXXXXXXXXXXX2 " + (template.reserved_offset + (is_mm ? mm_nonce_size : 0)));
        }
