...
function calcEthReward(block, tx_reciepts) {
    ...
    return (2 + 2 * (block.uncles.length / 32)) * 1000000000000000000 + fee;
}
...
function Coin(data){
    ...
    this.getPortBlockHeaderByID = function(port, blockId, callback){
        if (port == 11898) {
            ...
            global.support.rpcPortDaemon2(port, '', { jsonrpc: "2.0", id: 0, method: 'eth_getBlockByNumber', params: [  blockId2, true ] }, function (body) {
                if (!body || !body.result) {
                    console.error(JSON.stringify(body));
                    return callback(true, body);
                }
                global.support.rpcPortDaemon2(port, '', { jsonrpc: "2.0", id: 0, method: 'parity_getBlockReceipts', params: [ blockId2 ] }, function (body2) {
    ...
    this.getPortBlockTemplate = function(port, callback) {
		...
		method: 'getblocktemplate',
            ...
            global.support.rpcPortDaemon2(port, '', { jsonrpc: "2.0", id: 0, method: "eth_getWork", "params": [] }, function(body) {
    ...
    this.slowHashBuff = function(convertedBlob, blockTemplate, nonce, mixhash) {
        switch (blockTemplate.port) {
            ...
            case 8545:  return multiHashing.ethash(convertedBlob, Buffer.from(nonce, 'hex'), Buffer.from(mixhash, 'hex')); // ETH
