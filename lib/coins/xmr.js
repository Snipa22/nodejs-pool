...
function Coin(data){
    ...
    this.getPortLastBlockHeader = function(port, callback, no_error_report) {
        if (port == 11898) {
            ...
            global.support.rpcPortDaemon2(port, '', { method: 'getbestblockheader' }, function (body) {
                if (typeof(body) !== 'undefined'){
                    body.hash = body.hex;
                    return callback(null, body);
                } else {
    ...
    this.getPortBlockTemplate = function(port, callback) {
		...
		method: 'getblocktemplate',
                ...
                return callback(body ? cnUtils.RavenBlockTemplate(body, global.config.pool["address_" + port.toString()]) : null);
            });
