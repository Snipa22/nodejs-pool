...
function Coin(data){
    ...
    this.BlockTemplate = function(template) {
        ...
        if (is_mm) {
            ...
            if (template.parent_blocktemplate_blob[this.reserved_offset - 2] != 2 || template.parent_blocktemplate_blob[this.reserved_offset - 1] != 17) {
                console.error("INTERNAL ERROR: Parent block after serialization changed reserved_offset!");
            }
        }
