...
function Coin(data){
    ...
    this.convertAlgosToCoinPerf = function(algos_perf) {
        ...
        else if ("cn/wow" in algos_perf)        coin_perf[""]     = coin_perf["SUMO"] = coin_perf["LTHN"] = coin_perf["WOW"]  = algos_perf["cn/wow"];
    ...
    this.cryptoNight = function(convertedBlob, port, height) {
        switch (port) {
            ...
            case 19734: return multiHashing.cryptonight(convertedBlob, 13, height);	// SUMO
