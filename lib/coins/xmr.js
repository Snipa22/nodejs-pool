...
function Coin(data){
    ...
    this.cryptoNight = function(convertedBlob, port, height) {
        switch (port) {
            ...
            case 22023: return convertedBlob[0] >= 11 ? multiHashing.cryptonight_pico(convertedBlob, 0) : multiHashing.cryptonight_heavy(convertedBlob, 0); // LOKI
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 22023: return version >= 11 ? "cn-pico/trtl" : "cn-heavy/0";    // LOKI
