...
function Coin(data){
    ...
    this.getPortBlockHeaderByHash = function(port, blockHash, callback){
        ...
        if (port == 11898 || port == 20189 || port == 48782 || port == 11181) global.support.rpcPortDaemon(port, 'getblockheaderbyhash', {"hash": blockHash}, function (body) {
            ...
            global.support.rpcPortWallet(port+1, "get_transfer_by_txid", {"txid": body.result.miner_tx_hash}, function (body2) {
                ...
                if (body.result.block_header.reward !== reward_check) {
