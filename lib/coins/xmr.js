...
function Coin(data){
    ...
    this.convertAlgosToCoinPerf = function(algos_perf) {
        ...
        //if      ("panther" in algos_perf)         coin_perf["XTC"]  = algos_perf["panther"];
    ...
    this.slowHashBuff = function(convertedBlob, blockTemplate) {
	    ...
	    case 19994: return multiHashing.randomx(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 2);	// ArqMa
            ...
            //case 20189: return multiHashing.randomx(convertedBlob, Buffer.from(blockTemplate.seed_hash, 'hex'), 3);     // Scala
