...
function Coin(data){
    ...
    this.baseRavenDiff = function() {
        return bignum('00000000FF000000000000000000000000000000000000000000000000000000', 16);
    };
    ...
    this.convertRavenBlob = function(blobBuffer) {
        return cnUtil.convertRavenBlob(blobBuffer)
    };

    this.constructNewBlob = function(blockTemplate, nonce, port, maxhash) {
