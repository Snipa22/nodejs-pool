...
function Coin(data){
    ...
    this.getPortBlockTemplate = function(port, callback) {
		...
		method: 'getblocktemplate',
                ...
                if (body && body.result) switch (port) {
                  case 8766: return callback(cnUtil.RavenBlockTemplate(body.result, global.config.pool["address_" + port.toString()]) : null);
                  case 9998: return callback(cnUtil.RtmBlockTemplate(body.result, global.config.pool["address_" + port.toString()]) : null);
    ...
    this.convertBlob = function(blobBuffer, port, bt) {
    ...
    this.BlockTemplate = function(template) {
        ...
        this.nextBlobHex = function () {
            ...
            const blob = global.coinFuncs.convertBlob(this.buffer, this.port, this);
