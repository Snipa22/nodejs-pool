...
function Coin(data){
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 20189: return multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 5 ? 9 : 3);       // Stellite
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 20189: return version >= 5 ? "cn/half" : "cn/xtl";        // Stellite
    ...
    this.variantValue = function(port, version) {
        switch (port) {
            ...
            case 20189: return version >= 5 ? "half" : "xtl";  // Stellite
