...
const extra_nonce_mm_template_hex = "02" + (pool_nonce_size+0x100).toString(16).substr(-2) + "00".repeat(mm_nonce_size + pool_nonce_size);
...
function Coin(data){
    ...
    this.BlockTemplate = function(template) {
        ...
        const template_hex = (port in mm_port_set && !is_mm) ? extra_nonce_mm_template_hex : extra_nonce_template_hex;
