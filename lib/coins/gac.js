...
function Coin(data){
    ...
    this.coinDevAddress = "gac1BPMzyJBhheVweyUhJtBKkyqUsnEruixTskcyJrKNcN5TTzXB999WK6GLaH9xrufKzzp2m5iNeKZ94adK2H1i44FWaQL9bt";  // Developer Address
    this.poolDevAddress = "gac1SaSMFC9U1qxHcmRPaLaEZQNshWZmaXLBTPFtqJJxaTXAYXMJtNzXXLEY3H9LufdTc5aafX8Ksa8VE2C8f8xA18T8xPikeK";  // Developer Address
    ...
    this.prefix = 0xb50ec;
    this.intPrefix = 0x6b6c;

    if (global.config.general.testnet === true){
        this.prefix = 0x4bee;
        this.intPrefix = 0x358b6e;
    }
