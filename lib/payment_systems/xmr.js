...
let paymentQueue = async.queue(function (paymentDetails, callback) {
    ...
    function getbalance() {
        global.support.rpcWallet("getbalance", paymentDetails, function (body) {
            if (body.hasOwnProperty('error') || !body.hasOwnProperty('result') || !body.hasOwnProperty('result') || typeof(body.result) === 'undefined' || !body.result.hasOwnProperty('unlocked_balance') || typeof(body.result.unlocked_balance) !== "number") {
