...
function Database(){
    ...
    this.storeBulkShares = function(shareObject) {
        ...
        shareObject.forEach(function(data){
            ...
            let minerIDWithIdentifier = minerID + "_" + share.identifier;
            if (!cachedData.global_stats.hasOwnProperty('totalHashes')){
                cachedData.global_stats.totalHashes = 0;
            }
            if (!cachedData.global_stats.hasOwnProperty('roundHashes')){
            ...
            if (!cachedData[stats_type].hasOwnProperty('totalHashes')){
                cachedData[stats_type].totalHashes = 0;
            }
            if (!cachedData[stats_type].hasOwnProperty('roundHashes')){
            ...
            if (!cachedData[minerIDWithIdentifier].hasOwnProperty('totalHashes')){
                cachedData[minerIDWithIdentifier].totalHashes = 0;
            }
            if (!cachedData[minerIDWithIdentifier].hasOwnProperty('goodShares')){
                cachedData[minerIDWithIdentifier].goodShares = 0;
            }
            if (!cachedData[minerID].hasOwnProperty('totalHashes')){
                cachedData[minerID].totalHashes = 0;
            }
            if (!cachedData[minerID].hasOwnProperty('goodShares')){
