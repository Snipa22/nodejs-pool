...
function processShare(miner, job, blockTemplate, params) {
    ...
    if ("child_template" in blockTemplate) {
       console.log("XXX1 " + JSON.stringify(blockTemplate.child_template_buffer));
       console.log("XXX1 " + JSON.stringify(Buffer.from(JSON.stringify(blockTemplate.child_template_buffer))));
    }
    ...
    if ("child_template" in blockTemplate && hashDiff.ge(blockTemplate.child_template.difficulty)) { // Submit child block to the RPC Daemon.
        ...
        blockTemplate.child_template_buffer = Buffer.from(JSON.stringify(blockTemplate.child_template_buffer));
