    ...
    if (protoVersion === 1) {
        ...
        this.sendCoinJob = function(coin, params) {
            ...
            if (this.protocol == "grin") {
                ...
                return this.pushMessage({method: "mining.notify", params: job});
            } else {
    ...
    switch (method) {
        ...
        case 'login': { // grin and default
            ...
            if (id === "Stratum") {
                ...
                // extra_nonce is for AutoClient xmrig mode
                sendReply(null, { id: minerId, job: miner.getBestCoinJob(), extra_nonce: "", status: 'OK' });
