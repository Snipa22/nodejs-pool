    ...
    switch (method) {
        case 'login':
            ...
            miner = new Miner(
                ...
                params.coin, params["coin-perf"], params["coin-min-time"]
            );
            let time_now = Date.now();
        ...
        case 'getjob':
            ...
            miner.heartbeat();
            if (params.coin && params.coin instanceof Array && params["coin-perf"] && params["coin-perf"] instanceof Object) {
                const status = miner.setAlgos(params.coin, params["coin-perf"], params["coin-min-time"]);
                if (status != "") {
                    sendReply(status);
                    return;
                }
