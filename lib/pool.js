...
function retargetMiners() {
    ...
    if (elapsed > 100) console.error(threadName + "retargetMiners() consumed " + elapsed + " ms for " + activeMiners.size + " miners");
...
function checkAliveMiners() {
    ...
    const elapsed = Date.now() - time_before;
    if (elapsed > 100) console.error(threadName + "checkAliveMiners() consumed " + elapsed + " ms for " + activeMiners.size + " miners");
}
...
function setNewCoinHashFactor(isHashFactorChange, coin, coinHashFactor, check_height) {
    ...
    const elapsed = Date.now() - time_before;
    if (elapsed > 100) console.error(threadName + "setNewCoinHashFactor() consumed " + elapsed + " ms for " + activeMiners.size + " miners");
}
