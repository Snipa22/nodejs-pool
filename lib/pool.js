    ...
    if (coin in activeBlockTemplates) {
        if (activeBlockTemplates[coin].prev_hash === template.prev_hash) {
            if ("child_template" in template) {
                console.log("XXXXXXX0 " + template.child_template.prev_hash);
                console.log("XXXXXXX1 " + template.child_template_prev_hash);
                if ("child_template" in activeBlockTemplates[coin]) {
                console.log("XXXXXXX0 " + activeBlockTemplates[coin].template.child_template.prev_hash);
                console.log("XXXXXXX1 " + activeBlockTemplates[coin].template.child_template_prev_hash);
                }
                if ("child_template" in activeBlockTemplates[coin] && activeBlockTemplates[coin].child_template_prev_hash === template.child_template_prev_hash) {
                    console.log("XXXXXXX " + activeBlockTemplates[coin].child_template_prev_hash);
