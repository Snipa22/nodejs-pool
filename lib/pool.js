...
function handleMinerData(method, params, ip, portData, sendReply, pushMessage) {
    ...
    switch (method) {
        ...
        case 'submit':
            ...
            if (!blockTemplate || (activeBlockTemplate.height != job.height && lastBlockTemplateUpdateTime && Date.now() - lastBlockTemplateUpdateTime > 10*1000)) {
                let err_str = blockTemplate ? "Block outdated" : "Block expired";
