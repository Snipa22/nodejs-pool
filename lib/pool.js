...
function get_miner_agent_notification(agent) {
    ...
    if (m = reXMRig.exec(agent)) {
        ...
        if (majorv + minorv + minorv2 < 101) {
            console.error("Please update your xmr-node-proxy (" + agent + ") to version v0.1.1+ (check https://github.com/MoneroOcean/xmr-node-proxy repo)");
        }
