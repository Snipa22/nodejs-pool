    ...
    this.selectBestCoin = function() {
        ...
        if (typeof(this.curr_coin) === 'undefined' || this.curr_coin != best_coin) {
            ...
            if (factor != 1) {
                ...
                if (factor < 0.1 || factor > 10) console.error("!!! " + this.curr_coin + " to " + best_coin + " hash factor: " + factor + " '" + this.curr_coin_hash_factor + "' (" +  curr_hash_factor + " / " + currCoinHashFactorMM[best_coin] + ")");
            ...
            if (this.curr_coin_hash_factor == 0) console.error("!!! " + best_coin + " hash factor: 0");
