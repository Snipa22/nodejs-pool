    ...
    if (template.port in global.coinFuncs.getMM_CHILD_PORTS()) {
        ...
        for (let parent_port in parent_ports) {
            ...
            if (parent_coin in activeBlockTemplates) {
                ...
                const parent_template = process_rpc_template(activeBlockTemplates[parent_coin], parent_coin, parent_port, coinHashFactor, false);
                process.send ({type: 'newBlockTemplate', data: parent_template});
