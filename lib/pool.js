        ...
        // Success! Submitted a block without an issue.
            ...
            const get_block_id = function(cb) {
                if (global.coinFuncs.blobTypeDero(blob_type_num)) {
                    ...
                    global.coinFuncs.getPortBlockHeaderByID(blockTemplate.port, blockTemplate.height, function(err, body) {
                        console.log("ERG submit: " + JSON.stringify(body));
                    ...
                    return cb(rpcResult.result.substr(2));
                } else {
