...
function handleMinerData(method, params, ip, portData, sendReply, pushMessage) {
    ...
    switch (method) {
        case 'login':
            ...
            if (miner_agent_notification && anchorBlockHeight && anchorBlockHeight >= 1546000) {
                if (!(miner.payout in lastMinerNotifyTime) || time_now - lastMinerNotifyTime[miner.payout] > 10*60*1000) {
                    lastMinerNotifyTime[miner.payout] = time_now;
