    ...
    if (port == 8545 || port == 8645) {
        ...
        if (coin === "") {
          if (body_bt.prev_hash === lastBlockHash[coin]) {
            // replace body_header.hash (lastBlockHash) caching logic by body_bt.blockhashing_blob caching
            if (body_bt.blockhashing_blob === prevMainBlockBlob) return;
            prevMainBlockBlob = body_bt.blockhashing_blob;
