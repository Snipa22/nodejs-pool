...
function Miner(id, login, pass, ipAddress, startingDiff, messageSender, protoVersion, portType, port, agent, algos, algos_perf) {
    ...
    if (algos) {
        if (!algos_perf) algos_perf = { "cn/1": 1 };
    ...
    this.selectBestAlgo = function() {
        ...
        if (typeof(this.curr_algo) !== 'undefined' && this.curr_algo_time && this.algos_perf[this.curr_algo] && Date.now() - this.curr_algo_time < 5*60*1000) {
