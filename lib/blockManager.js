...
function calculatePPLNSPayments(block_height, block_reward, block_difficulty, unlock_callback) {
    ...
    async.doWhilst(function (callback) {
        ...
        global.mysql.query("SELECT SUM(amount) as amt FROM balance").then(function (rows) {
            ...
            const pay_window = totalPayments < default_window ? totalPayments : default_window;
            ...
            console.log("PPLNS payout cycle complete on block: " + block_height + " Block Value: " + global.support.coinToDecimal(block_reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / pay_window) * 100 + "% (precisely " + totalPayments + " / " + pay_window + ")");
            if (totalPayments != default_window) {
                console.warn("PPLNS payout cycle complete on block was corrected: " + block_height + " Block Value: " + global.support.coinToDecimal(block_reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / default_window) * 100 + "% (precisely " + totalPayments + " / " + default_window + ")");
                global.support.sendEmail(global.config.general.adminEmail,
                    ...
                    "PPLNS payout cycle complete on block: " + block_height + " Block Value: " + global.support.coinToDecimal(block_reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / pay_window) * 100 + "% (precisely " + totalPayments + " / " + pay_window + ")\n" +
                    "PPLNS payout cycle complete on block was corrected: " + block_height + " Block Value: " + global.support.coinToDecimal(block_reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / default_window) * 100 + "% (precisely " + totalPayments + " / " + default_window + ")"
                );
            }
        });
    });
