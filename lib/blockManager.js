    ...
    async.doWhilst(function (callback) {
        ...
        global.mysql.query("SELECT SUM(amount) as amt FROM balance").then(function (rows) {
            ...
            if (totalPayments != default_window) {
                console.log("PPLNS payout cycle complete on block was corrected: " + block_height + " Block Value: " + global.support.coinToDecimal(block_reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / default_window) * 100 + "% (precisely " + totalPayments + " / " + default_window + ")");
