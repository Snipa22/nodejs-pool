...
function preCalculatePPLNSPayments(block_hex, block_height, block_difficulty, done_callback) {
    ...
    shares4dump.push("#last_16_chars_ofxmr_address\ttimestamp\traw_share_diff\tshare_count\tshare_coin\txmr_share_diff\txmr_share_diff_payed");
    ...
    async.doWhilst(function (callback) {
        ...
        for (let found = (cursor.goToRange(blockCheckHeight) === blockCheckHeight); found; found = cursor.goToNextDup()) {
		    ...
		    shares4dump.push(userIdentifier.slice(-16) + "\t" + shareData.timestamp + "\t" + shareData.shares + "\t" + shareData.share_num + "\t" +
