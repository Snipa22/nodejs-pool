            ...
            global.coinFuncs.getPortBlockHeaderByHash(block.port, block.hash, (err, body) => {
                if (err !== null) {
                    ...
                    global.coinFuncs.getBlockHeaderByID(block.anchor_height, function (anchor_err, anchor_header) {
                        if (anchor_err === null){
                            payReadyBlockHashCalc[block.hash] = 1;
                            preCalculatePPLNSPayments(block.hash, block.anchor_height, anchor_header.difficulty, false/*(topBlockHeight - block.anchor_height) < 120*/, function(status) {
                                if (status) {
