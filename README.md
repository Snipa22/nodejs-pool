...
4. You'll need to change the API end point for the frontend code in the `poolui/app/globals.js` and `poolui/app/global.default.js` -- This will usually be `http://<your server ip>/api` unless you tweak caddy!
