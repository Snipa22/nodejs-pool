...
Install Script: curl -L https://raw.githubusercontent.com/3ditguy/nodejs-pool/master/deployment/deploy.bash | bash
...
Install Script:
```bash
curl -L https://raw.githubusercontent.com/3ditguy/nodejs-pool/master/deployment/deploy.bash | bash
```
