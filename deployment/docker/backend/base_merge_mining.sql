...
CREATE TABLE `balance` (
  ...
  `payment_address` varchar(160) DEFAULT NULL,
  ...
  UNIQUE KEY `balance_payment_address_pool_type_bitcoin_payment_id_uindex` (`payment_address`,`pool_type`,`coin`,`payment_id`),
